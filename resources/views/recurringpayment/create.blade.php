{{ Form::open(array('url' => 'recurringpayment','enctype' => 'multipart/form-data')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <div class="form-icon-user">
                {{ Form::text('policy_number', '', array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
            </div>
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="col-md-12">
            {{Form::label('add_receipt',__('Recurring Payment Receipt'),['class'=>'form-label'])}}
