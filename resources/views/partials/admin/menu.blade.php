                        ...
                        <ul class="dash-submenu  {{ (Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note'  )?'show':''}}">
                            ...
                            @endcan
                              @can('manage recurringpayment')
                                <li class="dash-item {{ (Request::route()->getName() == 'recurringpayment.index' || Request::route()->getName() == 'recurringpayment.create' || Request::route()->getName() == 'recurringpayment.edit') ? ' active' : '' }}">
                                    <a class="dash-link" href="{{route('recurringpayment.index')}}">{{ __('Recurring Payment') }}</a>
                                </li>
                            @endcan
