                    ...
                    @if (!empty($billPayment))
                        <div class="all-button-box mx-2">
                            <a href="#" data-url="{{ route('bill.debit.note', $bill->id) }}" data-ajax-popup="true"
                                data-title="{{ __('Add Debit Note') }}" class="btn btn-primary">
                                {{ __('Add Debit Note') }}
                            </a>
                        </div>
                    @endif
            ...
            <div class="col-10 offset-1 d-flex align-items-center justify-content-between justify-content-md-end">
                <div class="all-button-box mx-2">
                    <a href="#" data-url="{{ route('vender.bill.send', $bill->id) }}" data-ajax-popup="true"
                        data-title="{{ __('Send Bill') }}" class="btn btn-xs btn-white btn-icon-only width-auto">
                        {{ __('Send Mail') }}
                    </a>
                </div>
                <div class="all-button-box mx-2">
                            ...
                            <div class="row invoice-title mt-2">
                                ...
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h3 class="invoice-number">
                                        {{ Utility::billNumberFormat($company_setting, $bill->bill_id) }}</h3>
                                    ...
                                    <table class="table ">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    {{ utility::priceFormat($company_setting, $bill->getSubTotal()) }}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    {{ utility::priceFormat($company_setting, $bill->getTotalDiscount()) }}
                                                </td>
                                            </tr>
                                            ...
                                            @if (!empty($taxesData))
                                                @foreach ($taxesData as $taxName => $taxPrice)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            {{ utility::priceFormat($company_setting, $taxPrice) }}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            <tr>
                                                ...
                                                <td class="blue-text text-end">
                                                    {{ utility::priceFormat($company_setting, $bill->getTotal()) }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td class="text-end"><b>{{ __('Paid') }}</b></td>
                                                <td class="text-end">
                                                    {{ utility::priceFormat($company_setting, $bill->getTotal() - $bill->getDue() - $bill->billTotalDebitNote()) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                ...
                                                <td class="text-end">
                                                    {{ utility::priceFormat($company_setting, $bill->billTotalDebitNote()) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                ...
                                                <td class="text-end">
                                                    {{ utility::priceFormat($company_setting, $bill->getDue()) }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
