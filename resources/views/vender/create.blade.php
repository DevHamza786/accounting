    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::text('bank_account',null,array('class'=>'form-control','required'=>'required'))}}
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-4 col-sm-6">
            <div class="form-group">
                {{Form::label('bic_number',__('BIC Number'),['class'=>'form-label'])}}
                <div class="form-icon-user">
                    {{Form::text('bic_number',null,array('class'=>'form-control','required'=>'required'))}}
                </div>
            </div>
        </div>
