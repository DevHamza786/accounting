                            ...
                            @if (App\Models\Utility::getValByName('shipping_display') == 'on')
                                <div class="col ">
                                    <small>
                                        ...
                                        {{ !empty($customer->shipping_state) ? $customer->shipping_state : '' . ', ' }},{{ !empty($customer->shipping_country) ? $customer->shipping_country : '' }}<br>
                                        <strong>{{ __('Tax Number ') }} :
                                        </strong>{{ !empty($customer->tax_number) ? $customer->tax_number : '' }}
                                    ...
                                    <table class="table mb-0 table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><b>{{ \Auth::user()->priceFormat($total_sum_of_taxes) }}</b></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                            ...
                                            @if (!empty($taxesData))
                                                ...
                                                @foreach ($taxes as $tax)
                                                    ...
                                                    @endphp
                                                    @foreach ($temp2 as $tax)
                                                        <tr>
                                                            <td colspan="6"></td>
                                                            <td class="text-right"><b>{{ $tax['name'] }}</b></td>
                                                            <td class="text-right">
                                                                {{ \Auth::user()->priceFormat($tax['sum']) }}</td>
                                                        </tr>
                                                    @endforeach
                                                @endforeach
                                            @endif
                                            <tr>
                                                ...
                                                <td class="blue-text text-right">
                                                    {{ \Auth::user()->priceFormat($total_sum_of_taxes) }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
