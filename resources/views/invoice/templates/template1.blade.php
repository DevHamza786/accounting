            ...
            <tr>
                <td>
                    <p>
                        ...
                        @if($settings['company_address']){{$settings['company_address']}}@endif<br>
                        @if($settings['company_zipcode']){{$settings['company_zipcode']}}@endif
                        @if($settings['company_city']){{$settings['company_city']}}@endif<br>
                        @if($settings['company_state']){{$settings['company_state']}}@endif
                        @if($settings['company_country']){{$settings['company_country']}}@endif<br>
                        <br>
                        ...
                        @if(!empty($settings['tax_type']) && !empty($settings['vat_number'])){{__('VAT Number')}} : {{$settings['vat_number']}}<br>@endif
                    </p>
                </td>
                <td>
