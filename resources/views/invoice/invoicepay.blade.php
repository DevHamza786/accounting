                                        ...
                                        <div class="tab-pane fade " id="mollie-payment" role="tabpanel"
                                            ...
                                            <form role="form"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-prepend"><span
                                                                class="input-group-text">{{ App\Models\Utility::getValByName('site_currency_mollie') }}</span></span>

                                                        <input class="form-control" required="required" min="0"
                                                            name="amount" type="number" value="{{ __('Price') }}"
                                                            min="0" step="0.01" max="{{ __('Price') }}"
                                                            id="amount">
                                ...
                                <div class="tab-content">
                                    ...
                                    @if (
                                        ...
                                        <div class="tab-pane fade " id="mollie-payment" role="tabpanel"
                                            aria-labelledby="mollie-payment">
                                            <form role="form"
                                                action="{{ route('customer.invoice.pay.with.mollie') }}"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" required="required" min="0"
                                                            name="amount" type="number"
                                                            value="{{ __('Price') }}" min="0"
                                                            step="0.01" max="{{ __('Price') }}" id="amount">
                                    ...
                                    @if (
                                        ...
                                        <div class="tab-pane fade " id="skrill-payment" role="tabpanel"
                                            aria-labelledby="skrill-payment">
                                            <form role="form"
                                                action="{{ route('customer.invoice.pay.with.skrill') }}"
