                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($payments as $payment)
                                ...
                                <tr class="font-style">
                                    ...
                                    <td><span class="badge bg-primary mt-1 mr-2">{{  !empty($payment->tax_id)? DB::table('taxes')->where('id', $payment->tax_id)->first()->name . ' ' . '(' . DB::table('taxes')->where('id', $payment->tax_id)->first()->rate . '%)' :'-'}}</span></td>
