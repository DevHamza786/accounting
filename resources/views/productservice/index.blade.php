                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($productServices as $productService)
                                <tr class="font-style">
                                    ...
                                    <td class="text-center">{{ ($productService->sku == null) ? '-' : $productService->sku }}</td>
                                    <td>{{ \Auth::user()->priceFormat($productService->sale_price) }}</td>
                                    <td>{{  ($productService->purchase_price == 0.00) ? '-' : \Auth::user()->priceFormat($productService->purchase_price )}}</td>
                                    <td>
                                    ...
                                    <td>{{($productService->quantity == null) ? '-' : $productService->quantity}}</td>
