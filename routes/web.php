...
// Route::get('recurringpayment/index', [RecurringPaymentController::class,'index'])->name('recurringpayment.index')->middleware(['auth','XSS','revalidate']);


Route::resource('recurringpayment', RecurringPaymentController::class)->middleware(['auth', 'XSS', 'revalidate']);
