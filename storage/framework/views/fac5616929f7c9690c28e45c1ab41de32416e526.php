            ...
            <div class="col-10 d-flex align-items-center justify-content-between justify-content-md-end">
                ...
                <div class="all-button-box mr-3">
                    <a href="<?php echo e(route('invoice.pdf', Crypt::encrypt($invoice->id))); ?>" target="_blank"
                        class="btn btn-primary"><?php echo e(__('Download')); ?></a>
                    <?php if($invoice->getDue() > 0): ?>
                        <?php if(\Auth::guard('customer')->check()): ?>
                            ...
                            <a href="#" class="btn btn-xs btn-primary btn-icon-only width-auto"
                                title="<?php echo e(__('Pay Now')); ?>" data-bs-toggle="modal" data-bs-target="#paymentModal"><i
                                    class="fas fa-plus"></i> <?php echo e(__('Pay Now')); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
                                        ...
                                        <?php if(
                                            ...
                                            <li class="nav-item mb-2">
                                                <button class=" active btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    aria-selected="true"><?php echo e(__('Stripe')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(
                                            $company_payment_setting['is_paypal_enabled'] == 'on' &&
                                            ...
                                            <li class="nav-item mb-2">
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Paypal')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(
                                            ...
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Paystack')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_flutterwave_enabled']) &&
                                            ...
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    aria-selected="true"><?php echo e(__('Flutterwave')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_razorpay_enabled']) && $company_payment_setting['is_razorpay_enabled'] == 'on'): ?>
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Razorpay')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_mercado_enabled']) && $company_payment_setting['is_mercado_enabled'] == 'on'): ?>
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Mercado')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_paytm_enabled']) && $company_payment_setting['is_paytm_enabled'] == 'on'): ?>
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Paytm')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_mollie_enabled']) && $company_payment_setting['is_mollie_enabled'] == 'on'): ?>
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Mollie')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_skrill_enabled']) && $company_payment_setting['is_skrill_enabled'] == 'on'): ?>
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Skrill')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_coingate_enabled']) && $company_payment_setting['is_coingate_enabled'] == 'on'): ?>
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    type="button" role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('Coingate')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(
                                            $company_payment_setting['is_paymentwall_enabled'] == 'on' &&
                                            ...
                                            <li class="nav-item mb-2">
                                                ...
                                                <button class=" btn btn-outline-success btn-sm" id="pills-home-tab"
                                                    ...
                                                    type="button" role="tab" aria-controls="pills-home"
                                                    aria-selected="true"><?php echo e(__('PaymentWall')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <div class="tab-pane fade " id="mollie-payment" role="tabpanel"
                                            ...
                                            <form role="form"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-prepend"><span
                                                                class="input-group-text"><?php echo e(App\Models\Utility::getValByName('site_currency_mollie')); ?></span></span>

                                                        <input class="form-control" required="required" min="0"
                                                            name="amount" type="number" value="<?php echo e(__('Price')); ?>"
                                                            min="0" step="0.01" max="<?php echo e(__('Price')); ?>"
                                                            id="amount">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-prepend">
                                                            <span
                                                                class="input-group-text"><?php echo e(App\Models\Utility::getValByName('site_currency')); ?>
                                                ...
                                                <div class="col-12 form-group mt-3 text-end">
                                                    <input class="btn btn-sm btn-primary m-r-10" id="pay_with_paymentwall"
                                                        type="submit" value="<?php echo e(__('Make Payment')); ?>">
                                                </div>
                                        ...
                                        <table class="table mb-0 ">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td><b><?php echo e(Utility::priceFormat($company_setting, $totalRate)); ?></b>
                                                    </td>
                                                    <td>
                                                ...
                                                <?php if(!empty($taxesData)): ?>
                                                    ...
                                                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                <?php echo e(Utility::priceFormat($company_setting, $taxPrice)); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if(
                                        ...
                                        <div class="tab-pane fade " id="mollie-payment" role="tabpanel"
                                            aria-labelledby="mollie-payment">
                                            <form role="form"
                                                action="<?php echo e(route('customer.invoice.pay.with.mollie')); ?>"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" required="required" min="0"
                                                            name="amount" type="number"
                                                            value="<?php echo e(__('Price')); ?>" min="0"
                                                            step="0.01" max="<?php echo e(__('Price')); ?>" id="amount">
                                    ...
                                    <?php if(
                                        ...
                                        <div class="tab-pane fade " id="skrill-payment" role="tabpanel"
                                            aria-labelledby="skrill-payment">
                                            <form role="form"
                                                action="<?php echo e(route('customer.invoice.pay.with.skrill')); ?>"
...
<?php echo $__env->make('layouts.invoicepayheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/taim0or/Documents/accounting/resources/views/invoice/invoicepay.blade.php ENDPATH**/ ?>