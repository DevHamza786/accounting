    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::text('bank_account',null,array('class'=>'form-control','required'=>'required'))); ?>
        ...
        <div class="col-lg-5 col-md-4 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('bic_number',__('BIC Number'),['class'=>'form-label'])); ?>

                <div class="form-icon-user">
                    <?php echo e(Form::text('bic_number',null,array('class'=>'form-control','required'=>'required'))); ?>
...
<?php /**PATH /media/disk/server/q-boomverzorger/public_html/accounting/resources/views/vender/create.blade.php ENDPATH**/ ?>