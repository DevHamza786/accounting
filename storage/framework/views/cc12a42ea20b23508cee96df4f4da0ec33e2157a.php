...
<div class="bill-preview-main"  id="boxes">
    <div class="bill-header" style="">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('BILL')); ?></h3>
            ...
            <tr>
                ...
                <td>
                    <table class="no-space">
                        ...
                        <tr>
                            <td class="text-right" style="padding-left: 346px;"><?php echo e(__('Issue Date')); ?>:</td>
...
<?php /**PATH /media/disk/server/q-boomverzorger/public_html/accounting/resources/views/bill/templates/template3.blade.php ENDPATH**/ ?>