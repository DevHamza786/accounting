    ...
    <div class="row">
        <div class="col-md-6 name">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::text('name', '', array('class' => 'form-control','required'=>'required', 'placeholder' => 'Ex: Mark Ruffalo'))); ?>

                </div>
            </div>
        </div>
        <div class="col-md-6 tbd">
            <div class="form-group">
                <?php echo e(Form::label('sku', __('SKU'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
                <div class="form-icon-user">
                    <?php echo e(Form::text('sku', '', array('class' => 'form-control','required'=>'required', 'placeholder' => 'Ex: EH87492-32I0CMZ-19'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('sale_price', '', array('class' => 'form-control','required'=>'required', 'placeholder' => 'Ex: 10.00','step'=>'0.01'))); ?>                </div>
            </div>
        </div>
        <div class="col-md-6 tbd">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('purchase_price', '', array('class' => 'form-control','required'=>'required', 'placeholder' => 'Ex: 10.00','step'=>'0.01'))); ?>
        ...
        <div class="form-group col-md-6 tbd">
            <?php echo e(Form::label('quantity', __('Quantity'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
            <?php echo e(Form::text('quantity',null, array('class' => 'form-control','required'=>'required', 'placeholder' => 'Ex: 3'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="customRadio5" name="type" value="product" checked="checked" onclick="hide_show('product')">
                                <label class="custom-control-label form-label" for="customRadio5"><?php echo e(__('Product')); ?></label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="customRadio6" name="type" value="service" onclick="hide_show('service')">
...
<?php /**PATH /home/taim0or/Documents/accounting/resources/views/productservice/create.blade.php ENDPATH**/ ?>