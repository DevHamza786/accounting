                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <td class="text-center"><?php echo e(($productService->sku == null) ? '-' : $productService->sku); ?></td>
                                    <td><?php echo e(\Auth::user()->priceFormat($productService->sale_price)); ?></td>
                                    <td><?php echo e(($productService->purchase_price == 0.00) ? '-' : \Auth::user()->priceFormat($productService->purchase_price )); ?></td>
                                    <td>
                                    ...
                                    <td><?php echo e(($productService->quantity == null) ? '-' : $productService->quantity); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/taim0or/Documents/accounting/resources/views/productservice/index.blade.php ENDPATH**/ ?>