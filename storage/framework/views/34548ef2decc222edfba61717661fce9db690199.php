<?php echo e(Form::model($recurringpayment, array('route' => array('recurringpayment.update', $recurringpayment->id), 'method' => 'PUT','enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-12">
            ...
            <?php echo e(Form::text('policy_number', null, array('class' => 'form-control','rows'=>3))); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="choose-file form-group">
                ...
                <img id="image" class="mt-2" src="<?php echo e(asset(Storage::url('uploads/payment/'.$recurringpayment->add_receipt))); ?>" style="width:25%;" />
            </div>
        </div>
    </div>
</div>
...
</script><?php /**PATH /media/disk/server/q-boomverzorger/public_html/accounting/resources/views/recurringpayment/edit.blade.php ENDPATH**/ ?>