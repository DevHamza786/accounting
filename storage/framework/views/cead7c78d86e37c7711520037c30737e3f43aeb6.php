                ...
                <?php if( Gate::check('manage bill')  ||  Gate::check('manage payment') ||  Gate::check('manage debit note')): ?>
                    <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note'  )?' active dash-trigger':''); ?>">
                        ...
                        <ul class="dash-submenu  <?php echo e((Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note'  )?'show':''); ?>">
                            ...
                            <?php endif; ?>
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage recurringpayment')): ?>
                                <li class="dash-item <?php echo e((Request::route()->getName() == 'recurringpayment.index' || Request::route()->getName() == 'recurringpayment.create' || Request::route()->getName() == 'recurringpayment.edit') ? ' active' : ''); ?>">
                                    <a class="dash-link" href="<?php echo e(route('recurringpayment.index')); ?>"><?php echo e(__('Recurring Payment')); ?></a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH /media/disk/server/q-boomverzorger/public_html/accounting/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>