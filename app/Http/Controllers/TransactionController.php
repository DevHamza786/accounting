...
class TransactionController extends Controller
{
    ...
    {
         // dd(\Auth::user()->can('manage transaction'));
        ...
        if (\Auth::user()->can('manage transaction')) {
            ...
            // $accounts = RecurringTransaction::select('bank_accounts.id', 'bank_accounts.holder_name', 'bank_accounts.bank_name')
            //     ->leftjoin('bank_accounts', 'recurring_transactions.account', '=', 'bank_accounts.id')
            //     ->groupBy('recurring_transactions.account')->selectRaw('sum(amount) as total');
            ...
            // $transactions = RecurringTransaction::orderBy('id', 'desc');
